            ...
            <div className="card col-4 cardmin">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  He is also the author of _JavaScript: The Good Parts_. He has
                  been called a guru, but he is actually more of a mahatma.
                </p>
              </div>
            </div>
          ...
          <div className="card-deck">
            <div className="card col-4 cardmin">
              <div className="card-body">
                ...
                <p className="card-text">
                  Douglas Crockford is the author of <b>How JavaScript Works</b>
                  , the shocking best seller that rips the lid off behind the
                  scenes. In this light-hearted romp thru the world's most
                  misunderstood programming language, Crockford reveals what is
                  actually going on, and how we can use this to write better
                  programs. "
                </p>
              </div>
            </div>
